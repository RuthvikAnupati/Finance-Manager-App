              ...
              <div className="card-body">
                {categories.map(category => {
                  ...
                  return(
                    <>
                    {income > 0 &&
                      (<LineProgressBar label={category} percentage={incomePercent.toFixed(2)} lineColor={colors[category]} />)
              ...
              <div className="card-body">
                {categories.map(category => {
                  ...
                  return(
                    <>
                    {expenses > 0 &&
                      (<LineProgressBar label={category} percentage={expensePercent.toFixed(2)} lineColor={colors[category]}/>)
